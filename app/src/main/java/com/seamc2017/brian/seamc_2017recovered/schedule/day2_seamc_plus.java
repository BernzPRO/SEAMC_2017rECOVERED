...
public class day2_seamc_plus extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mScheduleList.add(new schedulelis(3, "Jim Kett", "09.00 - 10.00", "Raffles"));
        mScheduleList.add(new schedulelis(4, "Long Term Questions and Break", "10.00 - 10.30", "-"));
        mScheduleList.add(new schedulelis(5, "Individual Round", "10.30 - 12.00", "Sports Hall"));
        ...
        mScheduleList.add(new schedulelis(8, "Marcy Robertson", "14.00 - 15.00", "Raffles"));
        mScheduleList.add(new schedulelis(9, "Passback", "15.00 – 16.00", "Sports Hall"));
